...
mask_qq = (df_cut['prod_type'] == 1) | (df_cut['prod_type'] == 2)
df_qq=df_cut[mask_qq]
df_qq['prod_type'][df_qq['prod_type']==1]=0
...
plt.title('ROC Curve - Best Tuned Model - gq vs qq', fontsize=16, fontweight='bold')
plt.legend(loc="lower right", fontsize=12)
plt.grid(True, alpha=0.3)
plt.savefig(FilePath+'Plots/DNN1node/gq_qq_ROCcurve_best_model.png')
plt.close()

# FINAL SUMMARY
print("="*80)
print("FINAL SUMMARY- gq vs qq")
print("="*80)
